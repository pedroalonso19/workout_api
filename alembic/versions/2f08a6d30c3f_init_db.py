...
Revision ID: 2f08a6d30c3f
Revises: 3f628cab8bc5
Create Date: 2025-08-25 17:45:48.750005
...
revision: str = '2f08a6d30c3f'
down_revision: Union[str, Sequence[str], None] = '3f628cab8bc5'
...
def upgrade() -> None:
    ...
    sa.Column('centro_treinamneto_id', sa.Integer(), nullable=False),
    sa.Column('id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['categoria_id'], ['categorias.pk_id'], ),
    sa.ForeignKeyConstraint(['centro_treinamneto_id'], ['centros_treinamento.pk_id'], ),
    sa.PrimaryKeyConstraint('pk_id'),
